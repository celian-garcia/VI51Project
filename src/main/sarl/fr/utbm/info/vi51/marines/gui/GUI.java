 ...
 */
package fr.utbm.info.vi51.marines.gui;
...
public class GUI extends AbstractFrameworkGUI {
	 ...
	 * @param formations
	 */
	public GUI(float worldWidth, float worldHeight, TimeManager timeManager, Formation... formations) {
		super(
	 ...
	 */
	protected void paintFormations(Graphics2D g2d, List<Formation> formations) {
		Point2f pos, ppos;
		Vector2f orient;
		float l = 2f * SPOT_RADIUS;
		FormationSlot parent;
		for(Formation body : formations) {
