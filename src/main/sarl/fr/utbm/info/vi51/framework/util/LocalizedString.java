...
public class LocalizedString {
    ...
    public static String getString(Class<?> resource, String key, Object... params) {
    	return getString(resource.getClassLoader(),resource,key,params);
    }
    ...
    public static String getString(ClassLoader classLoader, Class<?> resource, String key, Object... params) {
    	...
    	String val = getStringWithDefaultFrom(classLoader,resource.getCanonicalName(),key,null,params);
    	if (val==null && classLoader!=resource.getClassLoader()) {
    		val = getStringWithDefaultFrom(classLoader,resource.getCanonicalName(),key,null,params);
    	}
    	while ((resource!=null)&&(val==null)) {
    ...
    public static String getStringWithDefault(Class<?> resource, String key, String defaultValue, Object... params) {
    	return getStringWithDefault(resource.getClassLoader(),resource,key,defaultValue,params);
    }
